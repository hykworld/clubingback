...
const EventListCard = ({ event, onEdit, onDelete, onImageClick }) => {
    ...
    const increaseViews = async (eventId) => {
        try {
            ...
            const response = await axios.patch(`http://3.133.122.248:4000/events/${eventId}/views`);
    ...
    const mutation = useMutation({
        mutationFn: async () => {
            const response = await axiosInstance.delete(`http://3.133.122.248:4000/events/${event._id}`, {
